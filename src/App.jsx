...
const[view,updateview]=useState(finaldata[3])
...
{finaldata.map((i)=>(
    <div id="mainbox" onClick={()=>{updateview(i)
      console.log(view)
    }} className="flex bg-[#bfdbfe] items-center hover:scale-105 mt-5 translate-y-7 ml-20 w-[400px] p-4 border rounded-lg shadow-lg">
      <img
